...
/**
 * class de criacao do labirinto de forma aleatoria
 *
 */
public class RandomMaze extends Maze implements Serializable{
	...
	/**
	 * cria um labirinto aleatorio recebendo como parametro o tamanho
	...
	/**
	 * metodo para criar o labirinto de forma aleatoria
	 * @param n
	 */
