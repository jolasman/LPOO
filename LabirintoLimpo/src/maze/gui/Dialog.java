...
public class Dialog extends JDialog {
	...
	JToggleButton btnDesenho = new JToggleButton("Desenho");
	...
	public Dialog() {
		...
		tglbtnAleatrio.setBounds(85, 13, 121, 23);
		...
		tglbtnEsttico.setBounds(216, 13, 121, 23);
		...
		btnDesenho.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {

				if(btnDesenho.isSelected()){
					tglbtnAleatrio.setSelected(false);
					tglbtnEsttico.setSelected(false);
				}
				andaSim.setEnabled(true);
		...
		btnDesenho.setBounds(347, 13, 121, 23);
		contentPanel.add(btnDesenho);
		{
