	...
	private void initialize() throws IOException {
		...
		butaoDesenhar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				JOptionPane.showMessageDialog(null,"Se quiser alterar as definições do labirinto\nconsulte o menu de Configurações"
						,"Informação",JOptionPane.INFORMATION_MESSAGE);

				painelDesenho.setCospe(dialog.getCospe());
				painelDesenho.setDorme(dialog.getDorme());
				painelDesenho.setAnda(dialog.getAnda());
				painelDesenho.setTamanho(dialog.getTamanho());
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(0<painelDesenho.verificaVezes("branco")){
					...
					painelJogo.newGameConstruido(painelDesenho.getLabirinto(),painelDesenho.getTamanho(),painelDesenho.getNumDrag(),
							...
							painelDesenho.getEscudo(),painelDesenho.getHeroi(),painelDesenho.getEspada(),painelDesenho.getCospe(),
							painelDesenho.getDorme(),painelDesenho.getAnda());
